  ...
  return (
    <div className="aboutContainer" style={{ marginLeft: '-21px' }}>
      <div className="aboutContent" style={{ paddingTop: '20px' }}>
        ...
        <h2>Meet Our Team</h2>
        <p>
          We have a dedicated team of professionals committed to delivering excellence in hostel management services. From developers to support staff, each member plays a crucial role in our success.
        </p>
      </div>
    </div>
  );
